...
function IncidentReportForm() {
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center mb-4 lg:mb-0">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-semibold text-gray-800">HTPL</span>
              </div>
            </div>
  ...
  >
    ...
    <option value="fire_drill">Fire Drill / Evacuation Training</option>
    <option value="equipment_handling">Equipment Handling Training</option>
    <option value="hazard_awareness">Hazard Awareness Training</option>
    <option value="emergency_response">Emergency Response Training</option>
    <option value="incident_reporting">Incident Reporting Protocol</option>
    <option value="workplace_ergonomics">Workplace Ergonomics Training</option>
    <option value="chemical_handling">Chemical Handling Training</option>
  </select>
</div>
