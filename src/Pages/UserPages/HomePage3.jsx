          ...
          <div className="space-y-8">
            ...
            <div className="border border-gray-300 p-3 mt-4">
              ...
              >
                ...
                <option value="equipment_handling">
                  Equipment Handling Training
                </option>
                <option value="hazard_awareness">
                  Hazard Awareness Training
                </option>
                <option value="emergency_response">
                  Emergency Response Training
                </option>
                <option value="incident_reporting">
                  Incident Reporting Protocol
                </option>
                <option value="workplace_ergonomics">
                  Workplace Ergonomics Training
                </option>
                <option value="chemical_handling">
